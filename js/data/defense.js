...
export const DEFENSA = {
   ...
   *
   * PRECIOS: todo (torres, trampas, armas y reparar) cuesta un poco mas
   * del DOBLE que antes, para que el dinero se note y haya que elegir
   * que montar en vez de comprarlo todo. Lo que dan los zombis y el
   * bonus por oleada NO han cambiado: lo que sube es el gasto.
...
export const TORRES = [
  {
    ...
    precio: 340, alcance: 520, dano: 10, cadencia: 5, velocidadBala: 1500,
    color: '#5b6874', acento: '#ffd23f',
  },
  {
    id: 'canon', name: 'Canon Pesado',
    desc: 'Mucho dano y atraviesa a varios.',
    precio: 580, alcance: 720, dano: 70, cadencia: 0.75, velocidadBala: 1900,
    perfora: true,
  ...
  },
  {
    ...
    precio: 450, alcance: 460, dano: 7, cadencia: 1.6, velocidadBala: 1300,
    efecto: 'hielo',
  ...
  },
  {
    ...
    precio: 700, alcance: 820, dano: 55, cadencia: 0.55, velocidadBala: 1100,
  ...
  },
  {
    ...
    precio: 620, alcance: 480, dano: 24, cadencia: 1.1, velocidadBala: 2200,
    efecto: 'cadena',
  ...
  },
  {
    ...
    precio: 520, alcance: 300, dano: 6, cadencia: 9, velocidadBala: 760,
  ...
  },
  {
    ...
    precio: 780, alcance: 1400, dano: 150, cadencia: 0.35, velocidadBala: 2600,
  ...
  },
  {
    ...
    precio: 660, alcance: 700, dano: 18, cadencia: 4, velocidadBala: 2600,
    perfora: true,
  ...
  },
  {
    ...
    precio: 580, alcance: 420, dano: 10, cadencia: 1.0, velocidadBala: 1500,
    efecto: 'aturde',
...
export const TRAMPAS = [
  ...
  },
  {
    ...
    precio: 160, usos: 40, dano: 0, espera: 0.6, w: 84, ralentiza: 0.25, duracion: 3,
    color: '#1f1a17', acento: '#4a3b30',
  },
  {
    id: 'mina', name: 'Mina',
    desc: 'Explota en area al pisarla. Pocos usos.',
    precio: 330, usos: 3, dano: 110, espera: 1.5, w: 44, radio: 130,
    color: '#4a4f3a', acento: '#ff3b3b',
  },
  {
    id: 'sierra', name: 'Sierra Circular',
    desc: 'Muerde fuerte y muy seguido.',
    precio: 310, usos: 25, dano: 45, espera: 0.45, w: 60,
...
export const TIENDA_ARMAS = [
  { id: 'municion', name: 'Municion completa', desc: 'Rellena todas tus balas.', precio: 90, municion: true },
  { id: 'fusil', arma: 'fusil', rareza: 'rare', precio: 270 },
  { id: 'escopeta', arma: 'escopeta', rareza: 'rare', precio: 330 },
  { id: 'llamas', arma: 'llamas', rareza: 'epic', precio: 480 },
  { id: 'rifle-hielo', arma: 'rifle-hielo', rareza: 'epic', precio: 570 },
  { id: 'cadena', arma: 'cadena', rareza: 'epic', precio: 660 },
  { id: 'lanzacohetes', arma: 'lanzacohetes', rareza: 'legendary', precio: 920 },
